...
@Component({
  selector: 'app-grid-device-type-firmware-measurement-type',
  templateUrl: './grid-device-type-firmware-measurement-type.component.html',
  styleUrls: ['./grid-device-type-firmware-measurement-type.component.css']
})
export class GridDeviceTypeFirmwareMeasurementTypeComponent extends BaseComponent implements OnInit {
 
  @Input() public deviceType: DTO.DeviceTypeDTO
  @Input() public deviceTypeFirmware: DTO.DeviceTypeFirmwareDTO

  public gridView: GridDataResult;
  public editDataItem: DTO.DeviceTypeFirmwareMeasurementTypeDTO;
  ...
  public refreshGrid($event) {
    this.service.deviceTypeFirmwareMeasurementTypeService.getsGrid(this.gridState, this.deviceType.id, this.deviceTypeFirmware.id).subscribe((result) => {
  ...
  public addHandler($event) {
    this.editDataItem = new DTO.DeviceTypeFirmwareMeasurementTypeDTO();
  ...
  public saveHandler(objToSave: any) {
    this.service.deviceTypeFirmwareMeasurementTypeService.save(objToSave, this.isNew, this.deviceType.id, this.deviceTypeFirmware.id).subscribe((data) => {
  ...
  private updateGridData(updatedObj: DTO.DeviceTypeFirmwareMeasurementTypeDTO, remove: boolean) {
  ...
  public confirmRemove(shouldRemove: boolean): void {
    ...
    if (shouldRemove) {
      this.service.deviceTypeFirmwareMeasurementTypeService.delete(this.itemToRemove, this.deviceType.id, this.deviceTypeFirmware.id).subscribe((data) => {
        if (data.isOk) {
