...
@Component({
  selector: 'app-grid-device-all',
  templateUrl: './grid-device-all.component.html',
  styleUrls: ['./grid-device-all.component.css']
})
export class GridDeviceAllComponent extends BaseComponent implements OnInit {
  ...
  public refreshGrid($event) {
    ...
    this.service.deviceService.getsAllDevicesGrid(this.gridState).subscribe((result) => {
