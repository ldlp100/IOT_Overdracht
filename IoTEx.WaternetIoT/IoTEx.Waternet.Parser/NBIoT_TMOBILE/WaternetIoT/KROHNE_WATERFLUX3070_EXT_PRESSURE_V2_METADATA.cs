...
namespace IOT.METADATA.KROHNE_WATERFLUX3070_EXT_PRESSURE_V2
{
    ...
    namespace MEASUREMENT
    {
        ...
        [MetaDataAttribute(Description = "Pressure in Bar", Unit = IOT.METADATA.UNITS.UnitsEnum.mBar, MemberIndex = 1, SensorIndex =1)]
        enum PRESSURE
        {
            [MetaDataAttribute(Description = "AVG", Value = 0)]
            AVG,
