...
namespace IOT.METADATA.KROHNE_WATERFLUX3070_V1
{
    ...
    {
        [MetaDataAttribute(Description = "FlowSpeed in oC", Unit = IOT.METADATA.UNITS.UnitsEnum.m_per_s, MemberIndex =1)]
        enum FLOW_SPEED
        {
        ...
        [MetaDataAttribute(Description = "Pressure in Bar", Unit = IOT.METADATA.UNITS.UnitsEnum.Bar, MemberIndex = 16)]
        enum PRESSURE
        {
            [MetaDataAttribute(Description = "AVG", Value = 0)]
            AVG,
        ...
        [MetaDataAttribute(Description = "Temperature in oC", Unit = IOT.METADATA.UNITS.UnitsEnum.oC, MemberIndex = 17)]
        enum TEMPERATURE
        {
            [MetaDataAttribute(Description = "AVG", Value = 0)]
            AVG,
