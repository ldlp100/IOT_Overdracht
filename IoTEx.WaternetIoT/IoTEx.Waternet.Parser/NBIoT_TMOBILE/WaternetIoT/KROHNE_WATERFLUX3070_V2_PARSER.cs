...
{
    public class KROHNE_WATERFLUX3070_V2_PARSER : IOT_DEVICE_GENERIC_V2_PARSER
    {
        ...
        public override void AddPostEvent(DeviceMessageDTO message, DeviceDefinitionDTO deviceInfo)
        {
            ...
            string eventName = IOT.METADATA.KROHNE_WATERFLUX3070_V2.MEASUREMENT.PRESSURE.AVG.GetType().Name + ".AVG";
            ...
            foreach (DeviceMessageEventDTO telemetry in telemetries)
            {
                ...
                SetMeasurement(message, (DateTime)telemetry.received, telemetry.EDUID,
                    IOT.METADATA.KROHNE_WATERFLUX3070_V2.MEASUREMENT.NAP_CORRECTED_PRESSURE.AVG,
