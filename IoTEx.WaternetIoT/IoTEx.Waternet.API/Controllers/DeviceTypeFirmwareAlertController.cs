...
namespace IoTEx.Waternet.API.Controllers
{
    [Authorize]
    [ApiController]
    [Route("/api/deviceTypes/{deviceTypeId}/firmwares/{firmwareId}/alerts/")]
    public class DeviceTypeFirmwareAlertController : BaseController
    {
        public DeviceTypeFirmwareAlertController(ILogger logger, IoTDBContext context, IConfiguration configuration)
        {
            ...
            APIRequestDTO request, Guid deviceTypeId, Guid firmwareId)
        {
            ...
            if (IsUserKnown())
            {
                ...
                IQueryable<DeviceTypeFirmwareEventStateTypeModel> instances = _dBcontext.DeviceTypeFirmware2EventStateTypes
                    ...
                    .Where(o => o.DeviceTypeFirmwareId == firmwareId && o.DeviceTypeFirmware.DeviceTypeId == deviceTypeId && o.IsAlert == true);
            ...
            Guid firmwareId)
        {
            if (IsUserKnown())
            {
                DeviceTypeFirmwareEventStateTypeModel instance = await _dBcontext.DeviceTypeFirmware2EventStateTypes
                    ...
                    .Include(o => o.UpdatedBy)
                    .Include(o => o.DeviceTypeFirmware)
                    .FirstAsync(o => o.Id == id && o.DeviceTypeFirmwareId == firmwareId && o.DeviceTypeFirmware.DeviceTypeId == deviceTypeId && o.IsAlert == true);
            ...
            Guid firmwareId, Guid id)
        {
            ...
            {
                DeviceTypeFirmwareEventStateTypeModel instance = await _dBcontext.DeviceTypeFirmware2EventStateTypes
                    .FirstOrDefaultAsync(o => o.Id == id && o.DeviceTypeFirmwareId == firmwareId && o.DeviceTypeFirmware.DeviceTypeId == deviceTypeId && o.IsAlert == true);
                if (instance == null)
                {
                    return NotFound();
                }
