...
namespace IoTEx.Waternet.API.Test
{
    public class UnitTestDeviceTypeFirmWareState
    {
        ...
        public UnitTestDeviceTypeFirmWareState()
        {
            ...
            _controller = new DeviceTypeFirmwareStateController(_logger, _dbContext, _configuration);
        ...
        private DeviceTypeFirmwareEventStateTypeViewModel GetViewModel()
        {
            ...
            {
                Name = "TestNameDeviceTypeFirmWareState",
                Description = "TestDescriptionDeviceTypeFirmWareState",
                IsAlert = false,
        ...
        public void Create()
        {
            ...
            result.Value.Value.Name.Should().Be("TestNameDeviceTypeFirmWareState");
            result.Value.Value.Description.Should().Be("TestDescriptionDeviceTypeFirmWareState");
            result.Value.Value.IsAlert.Should().BeFalse();
        }
        ...
        public void Update()
        {
            ...
            view.Name = "TestNameDeviceTypeFirmWareStateB";
            view.Description = "TestDescriptionDeviceTypeFirmWareStateB";
            view.Id = model.Id;
            AppUserModel? user = _contextCreator.GetUser();
            ...
            result.Value.Value.Created.Should().BeCloseTo(DateTime.Now, TimeSpan.FromSeconds(60));
            result.Value.Value.Updated.Should().BeCloseTo(DateTime.Now, TimeSpan.FromSeconds(60));
            result.Value.Value.Name.Should().Be("TestNameDeviceTypeFirmWareStateB");
            result.Value.Value.Description.Should().Be("TestDescriptionDeviceTypeFirmWareStateB");
            result.Value.Value.IsAlert.Should().BeFalse();
        }
